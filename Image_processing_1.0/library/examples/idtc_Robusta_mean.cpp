...
int main(){
	...
	const char* S1 = "Images/Idtc_Robusta/Image_R_Mean.pgm";
	I.SaveImage(S,S1);
	mat O = zeros<mat>(256,256);
	O = I.Idtc_Robusta(S, 0); //mean = 0
	const char* O1 = "Images/Idtc_Robusta/Image_F_Mean.pgm";
	I.SaveImage(O,O1);

	/*Ventana Opencv*/
	string label1 = "Salt and Pepper noise: 10";
	string label2 = "Idtc Robusta Mean";
